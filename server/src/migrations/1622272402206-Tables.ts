...
export class Tables1622272402206 implements MigrationInterface {
    name = 'Tables1622272402206'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "hole" ("id" SERIAL NOT NULL, "holeId" character varying NOT NULL, "holeStatus" character varying NOT NULL, "holeUpdateDate" character varying NOT NULL, "holeNumber" integer NOT NULL, "strokeHCP" integer NOT NULL, "holePar" integer NOT NULL, "holeHCP" integer NOT NULL, "holeTees" jsonb NOT NULL, "courseId" integer, "courseCourseId" character varying, CONSTRAINT "PK_6d1f7a83d98d71d24d9d605f2ee" PRIMARY KEY ("id", "holeId"))`);
        await queryRunner.query(`CREATE TABLE "course" ("id" SERIAL NOT NULL, "courseId" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "courseVersion" character varying NOT NULL, "createDate" character varying NOT NULL, "updateDate" character varying NOT NULL, "effectiveDate" character varying NOT NULL, "courseStatus" character varying NOT NULL, "courseType" character varying NOT NULL, "clubId" character varying NOT NULL, "coordinates" character varying NOT NULL, "courseName" character varying NOT NULL, "holesCount" integer NOT NULL, CONSTRAINT "PK_f57ae7dadd1fe4886c1228f1176" PRIMARY KEY ("id", "courseId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "round" ("id" SERIAL NOT NULL, "currentHole" integer NOT NULL, "holes" jsonb NOT NULL, "startHole" integer NOT NULL, "complete" boolean NOT NULL DEFAULT false, "endHole" integer NOT NULL, "mensTee" character varying NOT NULL, "womensTee" character varying NOT NULL, "courseId" integer, "courseCourseId" character varying, CONSTRAINT "PK_34bd959f3f4a90eb86e4ae24d2d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "hole_score" ("id" SERIAL NOT NULL, "strokes" integer NOT NULL, "holeNumber" integer NOT NULL, "playerId" integer, "roundId" integer, CONSTRAINT "UQ_cc45a6953447efb00d03b0cbfdf" UNIQUE ("playerId", "roundId", "holeNumber"), CONSTRAINT "PK_c4f559d455fa99dd20a14d49354" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_rounds_round" ("userId" integer NOT NULL, "roundId" integer NOT NULL, CONSTRAINT "PK_cdaa05f3c37fdee75f56e045a13" PRIMARY KEY ("userId", "roundId"))`);
